...
import fr.max2.packeta.network.ClientMessageHandler;
import fr.max2.packeta.network.IClientMessage;
import fr.max2.packeta.network.IServerMessage;
import fr.max2.packeta.network.ServerMessageHandler;
