...
import fr.max2.annotated.processor.util.model.element.TestingPackageElement;
import fr.max2.annotated.processor.util.model.element.TestingTypeElement;
import fr.max2.annotated.processor.util.model.type.TestingArrayType;
import fr.max2.annotated.processor.util.model.type.TestingDeclaredType;
import fr.max2.annotated.processor.util.model.type.TestingIntersectionType;
import fr.max2.annotated.processor.util.model.type.TestingPrimitiveType;
import fr.max2.annotated.processor.util.model.type.TestingUnionType;
import fr.max2.annotated.processor.util.model.type.TestingWildcardType;
