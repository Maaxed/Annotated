...
import fr.max2.annotated.processor.util.exceptions.InvalidPropertyException;
...
public class PropertyMap
{
	...
	private static class PropertyValue
	{
		...
		{
			if (!this.isString())
				throw new InvalidPropertyException("The value of the property '" + this.identifier + "' should be a string but is a property map");
