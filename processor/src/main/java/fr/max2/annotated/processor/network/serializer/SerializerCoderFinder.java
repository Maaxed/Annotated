...
public class SerializerCoderFinder extends CoderFinder<SerializationCoder>
{
	...
	public SerializerCoderFinder(ProcessingTools tools)
	{
		...
		this.scanClass("fr.max2.annotated.lib.network.serializer.SimpleClassSerializer");
		this.scanClass("fr.max2.annotated.lib.network.serializer.VectorClassSerializer");

		this.scanClass("fr.max2.annotated.lib.network.serializer.TagSerializer");
		...
		this.scanClass("fr.max2.annotated.lib.network.serializer.PrimitiveArraySerializer");
