...
import fr.max2.packeta.processor.network.datahandler.ArrayDataHandler;
import fr.max2.packeta.processor.network.datahandler.CollectionDataHandler;
import fr.max2.packeta.processor.network.datahandler.IDataHandler;
import fr.max2.packeta.processor.network.datahandler.MapDataHandler;
import fr.max2.packeta.processor.network.datahandler.NBTDataHandler;
import fr.max2.packeta.processor.network.datahandler.PrimitiveDataHandler;
import fr.max2.packeta.processor.network.datahandler.SerializableDataHandler;
import fr.max2.packeta.processor.network.datahandler.SimpleClassHandler;
import fr.max2.packeta.processor.network.datahandler.SpecialDataHandler;
...
public class DataHandlerParameters
{
	...
	public void setLoadedValue(Consumer<String> loadInstructions, String value)
	{
		...
		{
			loadInstructions.accept(NamingUtils.simpleTypeName(this.type) + " " + this.simpleName + " = " + value + ";");
		}
		else
		{
